...
# Run with Python 3!
# 
# 2021 Sergio Vilches (BST/EAS2)
#------------------------------------------------------------------------------

#------------------------------------------------------------------------------
# CONFIG
#------------------------------------------------------------------------------
# where the folders with the .tdms files are located.
# the folder name is be used to label the files
tdmsFoldersPath = '../measurements/byTicketNumber' 

# where to store the database with all the failure analysis data
xlsxFilePath = 'faDatabase.xlsx' 

# try reusing existing data in xlsxFilePath?
reuse_xlsx = False

# whether to retrieve part info from track&release (requires login info)
queryTRdata = True

# whether to retrieve the final test data of parts with known USNR
# requires setup of an ODBC connection (check ftQuery.py for instructions)
queryFTdata = False
...
# Find all tdms files
#------------------------------------------------------------------------------
tdmsList=pd.read_excel('faFileList.xlsx')
